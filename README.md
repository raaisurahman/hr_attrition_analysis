...
* **Demographic & Lifestyle Deep Dive:** Dedicated visualizations displaying attrition segmented by Age Group, Education Field, Marital Status, and Business Travel frequency, utilizing heatmaps to highlight high-risk categories (e.g., the 18 to 25 age bracket and the "Under 3k" salary band).
